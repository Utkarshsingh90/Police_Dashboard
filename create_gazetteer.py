...
def create_gazetteer_patterns():
    ...
    pattern file for the spaCy EntityRuler.[3, 4, 5]
    ...
    def add_pattern(label, text):
        ...
        if not isinstance(text, str) or not text.strip():
            return
        # Use lowercase text as the key to avoid duplicates like "Theft" and "theft"
    ...
    try:
        ...
        for field in data.get('fields',):
            ...
            if "IPC" in label:
                # Extracts "Murder" and "Section 302 IPC" from "Murder (Section 302 IPC)"
